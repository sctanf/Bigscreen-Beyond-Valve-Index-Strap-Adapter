...
- Pi Pico DAC - https://github.com/sctanf/picoamp-2
...
- For some common DACs or for software EQ (such as for Equalizer APO) there are a few presets and extra notes under [eq folder](../../tree/main/eq) and [picoamp](https://github.com/sctanf/picoamp-2) repository if needed
